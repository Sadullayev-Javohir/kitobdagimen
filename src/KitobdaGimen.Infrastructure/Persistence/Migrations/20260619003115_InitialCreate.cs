        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    BookId = table.Column<int>(type: "integer", nullable: false),
                    DailyPageGoal = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SavedQuotes_Quotes_QuoteId",
                        column: x => x.QuoteId,
                        principalTable: "Quotes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavedQuotes_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReadingProgress_ReadingGoals_ReadingGoalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingProgress_ReadingGoalId_Date",
                table: "ReadingProgress",
                columns: new[] { "ReadingGoalId", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SavedQuotes_QuoteId_UserId",
                table: "SavedQuotes",
                columns: new[] { "QuoteId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SavedQuotes_UserId",
                table: "SavedQuotes",
                column: "UserId");
