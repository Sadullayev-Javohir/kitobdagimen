...
public class GetActiveReadingGoalsQueryHandler
    : IRequestHandler<GetActiveReadingGoalsQuery, IReadOnlyList<ReadingGoalDto>>
{
    private readonly IAppDbContext _db;
    private readonly ICurrentUserService _currentUser;

    public GetActiveReadingGoalsQueryHandler(IAppDbContext db, ICurrentUserService currentUser)
    {
        _db = db;
    ...
    public async Task<IReadOnlyList<ReadingGoalDto>> Handle(
        GetActiveReadingGoalsQuery request, CancellationToken cancellationToken)
    {
